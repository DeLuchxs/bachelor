...
Eine Schwierigkeit dabei hat sich ergeben, als die ID nicht als erweiterter J1939-Standard erkannt wurde. 
...
DBC-Standard gefunden werden. Es wurde jedoch in einem Forum gefunden, dass diese Lösung funktioniert \cite{cantoolsIssue} (letzter Zugriff: 04.03.2025).
