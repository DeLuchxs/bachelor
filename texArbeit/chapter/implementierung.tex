...
\begin{itemize}
    ...
    \item \href{lightrun}{https://lightrun.com/answers/cantools-cantools-standard-frame-id-is-more-than-11-bits} (letzter Zugriff: 02.03.2025)
    \item funktioniert, weil dateiformat ein bit "missbraucht" um zu zeigen, dass es sich um eine extended ID handelt
    \item es gibt dazu keine offizielle Dokumentation, aber es funktioniert
